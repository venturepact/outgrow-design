...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.3.3", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
        ...
        function m(c) {
            ...
            if (b.opts.htmlAllowComments || c.nodeType != Node.COMMENT_NODE)
                ...
                else if (c.tagName && !c.tagName.match(F)) c.outerHTML = c.innerHTML;
            else {
                var f = c.attributes;
                if (f)
        ...
        function C() {
            for (var c = b.$el.get(0).querySelectorAll("ul, ol"), d = 0; d < c.length; d++)
                for (var e = b.node.contents(c[d]), f = null, g = e.length - 1; g >= 0; g--) "LI" != e[g].tagName ? (f || (f = a("<li>"), f.insertBefore(e[g])), f.append(e[g])) : f = null
        }
        ...
        function f(c, d) {
            if ("undefined" != typeof c && c || (c = b.$el.get(0)), "undefined" == typeof d && (d = !1), d && e(c), !c.getAttribute || "false" != c.getAttribute("contenteditable"))
                if (c.nodeType == Node.ELEMENT_NODE && ["STYLE", "SCRIPT", "HEAD"].indexOf(c.tagName) < 0)
                    for (var g = b.node.contents(c), h = g.length - 1; h >= 0; h--)(g[h].tagName != Node.ELEMENT_NODE || (g[h].className || "").indexOf("fr-marker") < 0) && f(g[h]);
        ...
        function d() {
            for (var c = [], d = b.$el.get(0).querySelectorAll(f()), e = 0; e < d.length; e++)
                if (!(d[e].querySelectorAll(a.FE.VOID_ELEMENTS.join(",")).length > 0 || d[e].querySelectorAll(b.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)").length > 0 || d[e].querySelectorAll(f()).length > 0)) {
        ...
        function y(a, c) {
            ...
            if (b.core.isEmpty() ? b.opts.fullPage && (d = r(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.find("head").get(0).outerHTML + "<body></body></html>") : ("undefined" == typeof a && (a = !1), b.opts.fullPage ? (d = r(b.iframe_document), d += "<html" + b.node.attributes(b.$html.get(0)) + ">" + b.$html.html() + "</html>") : d = b.$el.html()), !b.opts.useClasses && !c)
        ...
        function D(c, d, e) {
            b.selection.isCollapsed() || b.selection.remove();
            var f;
            if (f = d ? c : b.clean.html(c), f = f.replace(/\r|\n/g, " "), c.indexOf('class="fr-marker"') < 0 && (f = B(f)), b.core.isEmpty()) b.$el.html(f);
            else {
        ...
        function c() {
            ...
            }).text(b.language.translate(b.opts.placeholderText || b.$oel.attr("placeholder") || "")).css("height", b.$el.height() - Math.max(b.helpers.getPX(b.$el.css("margin-top")), c) - Math.max(b.helpers.getPX(b.$el.css("padding-top")), e)), b.$placeholder.html(b.$placeholder.text().replace(/\n/g, "<br>"))
        }
        ...
        function p(c, d, g) {
            ...
            if (h && "BLOCKQUOTE" == h.tagName) {
                if (e(c, h)) {
                    ...
                    return i ? a(h).before("<" + i + ">" + a.FE.MARKERS + "<br></" + i + ">") : a(h).before(a.FE.MARKERS + "<br>"),
                        a(c).remove(), !1
                }
        ...
        function d(a) {
            ...
            if (l = b.$win.scrollTop(), a && a.clipboardData && a.clipboardData.getData) {
                ...
                else c = d; if (m = "", /text\/html/.test(c) ? m = a.clipboardData.getData("text/html") : /text\/rtf/.test(c) && b.browser.safari ? m = a.clipboardData.getData("text/rtf") : /text\/plain/.test(c) && !this.browser.mozilla && (m = b.html.escapeEntities(a.clipboardData.getData("text/plain")).replace(/\n/g, "<br>")), "" !== m) return h(), a.preventDefault && (a.stopPropagation(), a.preventDefault()), !1;
                m = null
            }
            e()
        }
        ...
        function e(c, d) {
            var e = c.outerWidth();
            return c.parent().offset().left + d + e > b.helpers.getPX(a(b.opts.scrollableContainer).css("left")) + a(b.opts.scrollableContainer).width() - 10 && (d = a(b.opts.scrollableContainer).width() - e - 10 - c.parent().offset().left + a(b.opts.scrollableContainer).offset().left), c.parent().offset().left + d < a(b.opts.scrollableContainer).offset().left && (d = 10 - c.parent().offset().left + a(b.opts.scrollableContainer).offset().left), d
        }
...
/*!  * froala_editor font size css start here sahil */
...
/*!  * froala_editor font size css end here sahil  */

/*!  * froala_editor font color css start here sahil  */
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        function c() {
            ...
            if (c || (c = e()), !c.hasClass("fr-active"))
                if (b.popups.setContainer("colors.picker", b.$tb), h(c.find(".fr-selected-tab").attr("data-param1")), a.is(":visible")) {
...
/*!  * froala_editor font color css end here sahil  */